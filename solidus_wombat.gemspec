...
Gem::Specification.new do |gem|
  ...
  gem.name          = "solidus_wombat"
  gem.require_paths = ["lib"]
  gem.version       = '1.1.0.beta0'
  ...
  gem.add_development_dependency 'database_cleaner', '~> 1.4.1' # 1.4.0 is broken https://github.com/DatabaseCleaner/database_cleaner/issues/317
